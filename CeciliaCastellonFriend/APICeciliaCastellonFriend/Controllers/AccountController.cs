...
using APICeciliaCastellonFriend.Models;
using APICeciliaCastellonFriend.Providers;
using APICeciliaCastellonFriend.Results;

namespace APICeciliaCastellonFriend.Controllers
{
    [Authorize]
